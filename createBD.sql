...
CREATE TABLE VISITEUR (VIS_MATRICULE VARCHAR2(10) NOT NULL, VIS_ADRESSE VARCHAR2(50) NULL, VIS_CP VARCHAR2(5) NULL, VIS_DATEEMBAUCHE DATE NULL, VIS_NOM VARCHAR2(25) NULL, Vis_PRENOM VARCHAR2(50) NULL, VIS_VILLE VARCHAR2(30) NULL, LAB_CODE VARCHAR2(2) NOT NULL, SEC_CODE VARCHAR2(1) NULL, PRIMARY KEY (VIS_MATRICULE))
